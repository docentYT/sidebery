...
export const setupPageTranslations: Translations = {
  ...
  'settings.sub_panel.recently_closed_tabs': {
    ...
    pl: 'Ostatnio zamknięte sub panele kart',
  ...
  'settings.nav_bar_btn_remute_audio_tabs': {
    ...
    pl: 'Wycicz/Odcisz karty z dźwiękiem',
  ...
  'settings.dnd_outside_data': {
    ...
    pl: 'Przenieś przeniesione dane do celu',
  ...
  'settings.dnd_move_tabs_note': {
    ...
    pl: 'Info: Ctrl+Puść zapobiegnie kart',
  ...
  'settings.dnd_move_bookmarks': {
    ...
    pl: 'Usuń zakładki po opusczeniu ich do kart',
  ...
  'settings.dnd_move_bookmarks_note': {
    ...
    pl: 'Info: Ctrl+Puść zapobiegnie zakładkom',
...
範例： "*", "ctrl+$", "ctrl+alt+g"`,
  ...
  'settings.move_new_tab': {
    ...
    pl: 'Położenej nowej karty (zasada ogólna)',
    ru: 'Общее правило',
    zh_CN: '新标签的位置（通用规则）',
    zh_TW: '新分頁的位置（一般規則）',
  },
  ...
  'settings.auto_exp_tabs_on_new': {
    ...
    pl: 'Automatycznie rozwiń gałęź podczas tworzenia nowej karty potomnej',
  ...
  'settings.load_bookmarks_on_demand': {
    ...
    pl: 'Załaduj zakładki na rządanie',
  ...
  'settings.auto_menu_multi_sel_note': {
    ...
    pl: 'Tylko dla nienatwynego menu kontekstowego',
  ...
  'settings.mouse.new_tab_middle_click_action': {
    ...
    pl: 'Środkowy przycik myszy na przycisk tworzenia nowej karty',
